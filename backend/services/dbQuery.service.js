/**
 * @fileoverview This module defines SQL queries for user-related operations,
 * including creating a user
 ...
 *
 * @constant {string}
 * @description This query inserts a new user into
 * the `users` table with the following fields:
 ...
 *
 * @constant {string}
 * @description This query retrieves a user from
 * the `users` table based on the following conditions:
